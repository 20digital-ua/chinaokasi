<?php
$footer = get_field('section-footer', get_option( 'page_on_front' ));
?>
<footer>
		<div class="container">
			<div class="footer-container">
				<div class="copyright footer-item">
					<?=$footer['gr-1']['box1']['text']?>
					<div class="social social-icons">
							<a class="follow-link__follow social__twitter" target="_blank" href="<?=$footer['gr-1']['box1']['twitter_link']?>">
								<img  class="follow-link__icon icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/twitter-purple.png" alt="">
							</a>
							<a class="follow-link__follow social__instagram" target="_blank" href="<?=$footer['gr-1']['box1']['instagram_link']?>">
				...
				<div class="contact-info footer-item">
					<h4 class="contact-info__title"><?=$footer['gr-1']['box2']['title']?></h4>
					<p class="contact-info__subtitle"><?=$footer['gr-1']['box2']['subtitle']?></p>
					<p class="contact-info__phone"><?=$footer['gr-1']['box2']['phone']?></p>
				</div>
				
				<div class="address  address-item-1">
						<div class="address__city"><?=$footer['gr-2']['box1']['title']?></div>
						<div class="address__detailed"><?=$footer['gr-2']['box1']['address-text']?></div>
				</div>	
				<div class="address  address-item-2">
						<div class="address__city"><?=$footer['gr-2']['box2']['title']?></div>
						<div class="address__detailed"><?=$footer['gr-2']['box2']['address-text']?></div>
				</div>	
