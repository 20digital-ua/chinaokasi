				...
				<div class="menu-container">
					<nav class="main-menu">
						<ul class="pages-menu">
							...
							<li><a href="#">TV Clips & Photos</a></li>
						</ul>
			...
			<div class="container container--nopadding">
				<div class="about-china">
						<div class="china-photo">
							<img src="img/about-me/ChinaRedHat.png"  class="china-photo__img" alt="">
						...
						<div class="china-bio">
							...
							<a href="#" class="link-btn"><span class="link-inner">Read more</span></a>
						</div>
				</div>
		...
		<section class="podcast-section section">
			...
			<div class="container container--nopadding">
				<div class="podcast-introduce">
					...
					<img src="img/podcast/ChinaPodcastPhoto.png"  class="podcast-introduce__img" alt="">
				</div>
			</div>
			<div class="container container--podcast-player">
				...
				<div class="follow">
					<div class="follow-item">
						<div class="follow-content">
							<div class="follow-img">
								<img src="img/follow-me/Avatar-violet.png" alt="">
							</div>	
					...
					<div class="follow-item">
							<div class="follow-content">
								<div class="follow-img">
									<img src="img/follow-me/Avatar3.png" alt="">
								</div>	
								<div class="follow-link">
