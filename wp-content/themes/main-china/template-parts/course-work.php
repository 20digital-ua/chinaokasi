<main>
			...
			<div class="container">
				<div class="cinfo">
					<div class="cinfo-content">
						...
						<h1 class="cinfo-content__title">Work</h1>
						<span class="cinfo-content__subtitle"><span>my </span> Career — Guide Channel</span>
					</div>
					<ul class="info-list">
		...
		<section class="blog-section section">
			<div class="container">
					<h2 class="title">Blog Posts on my <span class="title--red">WORK</span>  channel</h2>
			</div>
