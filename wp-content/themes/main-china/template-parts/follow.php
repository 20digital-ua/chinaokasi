<?php 
$follow = get_field('section-3', get_option( 'page_on_front' ))['follow_blocks'];
	...
	<div class="follow-item">
		<div class="follow-content">
			...
			<div class="follow-link">
				...
				<a class="follow-link__follow social-twitter" target="_blank" href="<?=$follow['block_1']['link']?>">
					<img  class="follow-link__icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/twitter-purple.png" alt="">
					<span class="link-text"><?=$follow['block_1']['follow_text']?></span>	
				</a>
			</div>
		</div>
		<div class="follow-additional"><?=$follow['block_1']['text']?></div>
	</div>
	<div class="follow-item">
			<div class="follow-content">
				<div class="follow-img">
				...
				<div class="follow-link">
					...
					<a class="follow-link__follow follow-link__follow-red" target="_blank" href="<?=$follow['block_2']['link']?>">
			...
			<div class="follow-additional"><?=$follow['block_2']['text']?></div>
		</div>
</div>