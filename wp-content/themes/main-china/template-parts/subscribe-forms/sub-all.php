...
<div id="mc_embed_signup">
  <form action="https://gmail.us3.list-manage.com/subscribe/post?u=299144442459ae6cad07bdcff&amp;id=bbe289ae96" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate primary-form header-form" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
      ...
      <div class="mc-field-group input-group" style="display:none;">
        <strong>Subs </strong>
        <ul>
        <li><input type="radio" value="1" name="group[23609]" id="mce-group[23609]-23609-0" checked><label for="mce-group[23609]-23609-0">All</label></li>
      ...
      <div class="clear"><input type="submit" value="Join my movement" name="subscribe" id="mc-embedded-subscribe" class="button primary-form__submit submit-btn"></div>
    </div>
  </form>
</div>
