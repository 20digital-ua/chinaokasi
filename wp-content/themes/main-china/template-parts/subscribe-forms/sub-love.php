...
<div id="mc_embed_signup">
  <form  action="https://gmail.us3.list-manage.com/subscribe/post?u=299144442459ae6cad07bdcff&amp;id=bbe289ae96" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate primary-form single-course-form" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
      ...
      <button name="subscribe" id="mc-embedded-subscribe" class="course__takelink takeBtn"><span class="link-inner">Take <span class="link-inner-sm">LOVE</span> Course</span></button>
      ...
      <div class="mc-field-group input-group" style="display:none;">
        ...
        <li><input type="radio" value="8" name="group[23609]" id="mce-group[23609]-23609-3" checked><label for="mce-group[23609]-23609-3">Love</label></li>
