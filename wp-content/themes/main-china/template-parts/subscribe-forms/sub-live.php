...
<div id="mc_embed_signup">
  <form  action="https://gmail.us20.list-manage.com/subscribe/post?u=ef335dd7b9dff42381a557625&amp;id=eb6dd1fe6d" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate primary-form single-course-form" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
      ...
      <button name="subscribe" id="mc-embedded-subscribe" class="course__takelink takeBtn"><span class="link-inner">Take <span class="link-inner-sm">LIVE</span> Course</span></button>
      ...
      <div class="mc-field-group input-group" style="display:none;">
        ...
        <ul>
          ...
          <li><input type="radio" value="1" name="group[3467]" id="mce-group[3467]-3467-1" checked><label for="mce-group[3467]-3467-1">Live</label></li>
